<ul id="SiteMap">
<% control Menu(1) %>
	<li class="$FirstLast SiteMapLevel1<% if SiteMapPages %><% else %> noChildrenLI<% end_if %>">
		...
		<ul id="sublist{$ID}"><% control SiteMapPages %>
			<li class="$FirstLast SiteMapLevel2<% if SiteMapPages %><% else %> noChildrenLI<% end_if %>">
				...
				<% if SiteMapPages %>
				<ul id="sublist{$ID}"><% control SiteMapPages %>
					<li class="$FirstLast SiteMapLevel3<% if SiteMapPages %><% else %> noChildrenLI<% end_if %>">
						...
						<% if SiteMapPages %>
						<ul id="sublist{$ID}"><% control SiteMapPages %>
							<li class="$FirstLast SiteMapLevel4<% if SiteMapPages %><% else %> noChildrenLI<% end_if %>">
								...
								<ul><li class="$FirstLast SiteMapLevel5 noChildrenLI"><a href="$Link" class="pageTitle SiteMapLevel5">$Title <% if SiteMapPages %> ... there are more pages in this section <% end_if %></a></li></ul>
								<% end_control %><% end_if %>
							</li><% end_control %>
						</ul><% end_if %>
					</li><% end_control %>
