...
class PhotographicProduct extends Product {
	...
	static function set_can_create($v) {
		self::$can_create = $v;
		PhotographicProductGroup::$can_create = $v;
	}
	...
	static $icon = "ecommercextras/images/treeicons/PhotographicProduct";

	static $add_action = "a Photographic product";

	public static $many_many = array(
		'PhotographicProductGroups' => 'PhotographicProductGroup'
	);
...
class PhotographicProduct_Controller extends Product_Controller {
