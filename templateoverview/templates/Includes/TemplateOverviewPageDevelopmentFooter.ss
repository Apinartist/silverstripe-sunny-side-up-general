...
<div id="TemplateOverviewPageDevelopmentFooter" style="margin-top: 100px; width: 100%; clear: both; background-color: #999; border-top: 10px solid #fff; text-align: center; font-size: 1.5em;">
	<p style="padding: 2em;"><a href="{$TemplateOverviewPage.Link}showmore/$ID" style="color:#fff; ">$ClassName: compare to design</a>, or see <a href="{$TemplateOverviewPage.Link}">a list of all templates</a></p>
